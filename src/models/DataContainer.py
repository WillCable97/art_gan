...
A=TensorflowDataObject(records_path, feature_description, 'text_feature')
tfrecord_file=A.tfrecord_file
raw_dataset=A.raw_dataset
parsed_dataset=A.parsed_dataset

A.create_batched_data(32,1000)
print(A.goto_next_batch())
